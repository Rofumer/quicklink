package com.maximpolyakov.quicklink.forge.compat.ftbchunks;
...
/**
 * Soft-dependency bridge for FTB Chunks (Forge 1.20.1).
 ...
 * Chunks is absent. Callers must guard with QuickLinkForge.FTBCHUNKS_LOADED before invoking.
 */

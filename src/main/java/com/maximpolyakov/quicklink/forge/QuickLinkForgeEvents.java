...
@Mod.EventBusSubscriber(modid = QuickLink.MOD_ID, bus = Mod.EventBusSubscriber.Bus.FORGE)
public class QuickLinkForgeEvents {
    ...
    public static void onRightClickBlock(PlayerInteractEvent.RightClickBlock event) {
        ...
        if (!(be instanceof ItemPlugBlockEntity)
                ...
                && !(be instanceof FluidPlugBlockEntity)
                && !(be instanceof ChemicalPlugBlockEntity)) return;

        // Cancel before vanilla/Forge processes dye interaction
        ...
        else if (be instanceof ChemicalPlugBlockEntity cbe) cbe.setColor(face, slot, QuickLinkColors.UNSET);

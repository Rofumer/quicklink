...
public final class QuickLinkColors {
    ...
    public int pack() {
        return (c0 & 0xF) | ((c1 & 0xF) << 4) | ((c2 & 0xF) << 8) | ((c3 & 0xF) << 12);
    }

    public int networkKey() { return pack(); }
    ...
    public byte get(int slot) {
        return switch (slot) {
            ...
            default -> throw new IllegalArgumentException("slot must be 0..3");
        };
    }
    ...
    public byte[] toArray() { return new byte[]{c0, c1, c2, c3}; }
    ...
    @Override public int hashCode() { return Objects.hash(c0, c1, c2, c3); }

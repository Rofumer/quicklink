...
public class QuickLinkNetworkManager extends SavedData {
    ...
    private static final SavedDataType<QuickLinkNetworkManager> TYPE = new SavedDataType<>(
            Identifier.fromNamespaceAndPath("quicklink", "network_mgr"),
    ...
    public List<GlobalPosRef> getPlugsSnapshot(int key) {
        ...
        out.sort(QuickLinkNetworkManager::compareRefs);
        return out;
    }

...
public class FluidPlugBlockEntityRenderer implements BlockEntityRenderer<FluidPlugBlockEntity, FluidPlugBlockEntityRenderer.PlugRenderState> {
    ...
    @Override
    public void extractRenderState(FluidPlugBlockEntity be, PlugRenderState state,
        ...
        for (Direction face : Direction.values()) {
            ...
            state.active[i]   = role != FluidPlugBlockEntity.SideRole.NONE;
            state.hasPlug[i]  = role == FluidPlugBlockEntity.SideRole.PLUG || role == FluidPlugBlockEntity.SideRole.BOTH;
            state.hasPoint[i] = role == FluidPlugBlockEntity.SideRole.POINT || role == FluidPlugBlockEntity.SideRole.BOTH;
    ...
    private static void drawQuadrant(VertexConsumer vc,PoseStack.Pose pose,Matrix4f mat,
                                     ...
                                     float U0,float U1,float V0,float V1,byte dyeId,int light,int overlay){
